...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Reduce takes a sequence and returns a single value by reducing the
        # sequence as per the given method. It also takes initial value which
        # is taken before the first sequence and also is used when the sequence
        # is empty.
